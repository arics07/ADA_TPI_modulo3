...
// Creo el objeto authorModel, que contiene funcionalidades para leer (readPublishers) y escribir (writePublishers) en un archivo JSON
const publishersModel = {
    ...
    writePublishers: (publishers) => {
        const jsonData = JSON.stringify(publishers, null, 2); //convierto el objeto a una cadena JSON con formato (para eso pasamos null y 2 como parámetros)
